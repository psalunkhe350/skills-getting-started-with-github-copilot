document.addEventListener("DOMContentLoaded", () => {
              ...
              <ul class="participants-list">
                ${details.participants.map(email => `
                  <li>
                    ...
                    <button class="delete-participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(email)}" title="Unregister participant">✖</button>
                  </li>
                `).join('')}
              </ul>
            </div>
  ...
  activitiesList.addEventListener('click', async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Refresh activities to show the updated participants
        fetchActivities();
      } else {
